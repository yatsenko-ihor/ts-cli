...
- [ ] add in app and into interactive menu separate accounts and their machines. Also option p - to select profile(account) in this mode shows machines only for that account
